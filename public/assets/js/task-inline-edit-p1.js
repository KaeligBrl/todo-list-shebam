(function ($) {
    ...
    function bindInlineEditP1() {
        var updateUrlTemplate = window.currentWeekP1InlineUpdateUrlTemplate;
        var $editRow = $("#inlineEditTaskP1Row");
        var $errorRow = $("#inlineEditTaskP1Errors");
