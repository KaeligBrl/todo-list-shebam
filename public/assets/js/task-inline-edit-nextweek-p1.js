(function ($) {
    ...
    function bindInlineEditNextWeekP1() {
        var updateUrlTemplate = window.nextWeekP1InlineUpdateUrlTemplate;
        var $editRow = $("#inlineEditTaskNwP1Row");
        var $errorRow = $("#inlineEditTaskNwP1Errors");
