...
class QuoteController extends AbstractController
{
    ...
    /**
     * @Route("/semaine-actuelle/devis", name="current_week_quote")
     */
    public function index(QuoteRepository $quoteList, Request $request): Response
    {
        ...
        return $this->render('front/current_week/quote/list.html.twig', [

            'quote' => $quoteList->findBy([], ['position' => 'ASC']),
            'form_quote_cw_add' => $formquote->createView(),
            'notification' => $notification,
        ]);
    }

    /**
     * @Route("/semaine-actuelle/devis/modifier/{id}", name="modify_quote_cw")
     */
    ...
    /**
     * @Route("/semaine-actuelle/devis/supprimer/{id}", name="delete_quote_cw")
    ...
    public function deleteQuote(Quote $quoteDelete): RedirectResponse
    {
        ...
        return $this->redirectToRoute("current_week_quote");
    }

    /**
     * @Route("/semaine-actuelle/devis/basculer/semaine-suivante/{id}", name="change_quote_cw_to_nw")
     * return RedirectResponse
     */
