...
class ToCurrentWeekController extends AbstractController
{
     ...
     */
    public function changeWaitingReturnNextWeekToWaitingReturnCurrentWeek(WaitingReturn $waitingReturn, WaitingReturnRepository $waitingReturnRepository): Response
    {
