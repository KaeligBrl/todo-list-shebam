 ...
 */
class getTask2RepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\Task2Repository' shared autowired service.
     *
     * @return \App\Repository\Task2Repository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Task2Repository.php';

        return $container->privates['App\\Repository\\Task2Repository'] = new \App\Repository\Task2Repository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
