...
class __TwigTemplate_46b92ed2538c256572e789d2ab5cfc1730c2fcf6fc53110f1eca6ccb795406e2 extends Template
{
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Modifier la tâche - Administration";
...
\t\t\t\t\t";
        // line 22
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form_task_list_modify_admin"]) || array_key_exists("form_task_list_modify_admin", $context) ? $context["form_task_list_modify_admin"] : (function () { throw new RuntimeError('Variable "form_task_list_modify_admin" does not exist.', 22, $this->source); })()), 'form');
        echo "
\t\t\t\t</div>
\t\t\t</div>
\t\t</div>
...
{% block title %}Modifier la tâche - Administration{% endblock %}

{% block body %}
\t<div>
\t\t{% block titre_admin_page %}Tâche - Modifier{% endblock %}
\t</div>
...
\t\t\t<div class=\"row\">
\t\t\t\t<div class=\"col-6\">
\t\t\t\t\t{{ form(form_task_list_modify_admin) }}
\t\t\t\t</div>
\t\t\t</div>
\t\t</div>
\t{% endblock %}
