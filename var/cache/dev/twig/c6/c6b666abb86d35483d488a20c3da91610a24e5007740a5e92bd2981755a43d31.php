...
/* back/customer/list.html.twig */
class __TwigTemplate_99ca6f23afcb18a555306a4bcec88f8f5f638edfe37269ce6e3ab9daef766a2f extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "back/customer/list.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "back/customer/list.html.twig"));

        $this->parent = $this->loadTemplate("back/index.html.twig", "back/customer/list.html.twig", 1);
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Liste des clients - Administration";
...
\t";
    ...
    {
        return "back/customer/list.html.twig";
    }
...
{% block title %}Liste des clients - Administration{% endblock %}

{% block body %}
\t<div>
\t\t{% block titre_admin_page %}Liste des client{% endblock %}
\t</div>
\t{% block admin_utilisateur %}
\t\t<div class=\"container\">
\t\t\t<div class=\"d-flex flex-row-reverse\">
\t\t\t\t<a href=\"{{ path('customer_add_admin') }}\" type=\"button\" class=\"btn btn-outline-light mb-3\">
\t\t\t\t\t<i class=\"fas fa-plus-circle\"></i>
\t\t\t\t</a>
\t\t\t</div>
...
\t\t\t\t\t\t\t<td>{{customer.name}}</td>
\t\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t\t<a href=\"{{ path('customer_modify_admin', {\"id\": customer.id}) }}\"><i class=\"fas fa-cog\"></i></a>
\t\t\t\t\t\t\t\t|
\t\t\t\t\t\t\t\t<a href=\"{{ path('customer_detete_admin', {\"id\": customer.id}) }}\" onclick=\"return confirm('Attention vous vous apprettez à supprimer un client')\"><i class=\"fas fa-trash\"></i></a>
\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t</tr>
\t\t\t\t\t{% endfor %}
...
", "back/customer/list.html.twig", "C:\\laragon\\www\\to-do-list-shebam\\templates\\back\\customer\\list.html.twig");
    }
}
